...
public class CIDRTest {
	...
	/**
	 * Test method for {@link org.trillinux.ipheatmap.common.CIDR#CIDR(org.trillinux.ipheatmap.common.CIDR)}.
	 */
	@Test
	public void testCIDRCIDR() {
		CIDR cidr = new CIDR("0.0.1.0/24");
		CIDR copy = new CIDR(cidr);
		assertEquals(cidr.start, copy.start);
		assertEquals(cidr.end, copy.end);
		assertEquals(cidr.mask, copy.mask);
	}

	/**
	 * Test method for {@link org.trillinux.ipheatmap.common.CIDR#CIDR(java.lang.String)}.
	 */
	@Test
	...
	/**
	 * Test method for {@link org.trillinux.ipheatmap.common.CIDR#overlaps(org.trillinux.ipheatmap.common.CIDR)}.
	 */
	@Test
